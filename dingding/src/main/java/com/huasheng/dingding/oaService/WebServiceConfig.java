...
public class WebServiceConfig {
	...
	private void loadCfg() {
		...
		try{
			this.address = ClientConstant.ADDRESS;
			String serviceClassName = ClientConstant.SERVICE_CLASS;
			this.serviceClass = Class.forName(serviceClassName);
			this.serviceBean = ClientConstant.SERVICE_BEAN;
			this.user = "admin";
			this.password = "dghs@abc123";
		}catch (Exception e){
